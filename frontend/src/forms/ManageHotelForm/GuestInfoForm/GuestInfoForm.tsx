...
const GuestInfoForm=({ hotelId , pricePerNight } :Props)=>{
    ...
    const bookingUrl = `/hotel/${hotelId}/booking`;
        ...
        <div className="flex flex-col p-4 bg-blue-200 gap-4">
            ...
            <div className="grid grid-cols-1 gap-4 items-center">
              ...
              />
                ...
                {errors.adultCount &&(
                    <span className="text-rd-500 font-semibold text-sm">
              ...
              {isLoggedIn?(
                <Link to={bookingUrl} className="bg-blue-600 text-white h-full p-2 font-bold hover:bg-blue-500 text-xl">Book Now</Link>
